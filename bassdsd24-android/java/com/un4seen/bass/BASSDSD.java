/*
	...
	Copyright (c) 2014-2023 Un4seen Developments Ltd.
...
public class BASSDSD
{
	...
	public static native int BASS_DSD_StreamCreateFile(BASS.Asset file, long offset, long length, int flags, int freq);
	public static native int BASS_DSD_StreamCreateFile(ParcelFileDescriptor file, long offset, long length, int flags, int freq);
