...
public class BASSWEBM
{
	...
	public static final int BASS_ATTRIB_WEBM = 0x16002;
	...
	public static native int BASS_WEBM_StreamCreateFile(BASS.Asset file, long offset, long length, int flags, int track);
	public static native int BASS_WEBM_StreamCreateFile(ParcelFileDescriptor file, long offset, long length, int flags, int track);
